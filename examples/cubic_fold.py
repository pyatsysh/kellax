...
def main():
    ...
    br = arclength_continuation(R, np.array([-1.2]), p0 = 0.7, ds = 0.03,
                                ds_max = 0.06, n_steps = 600, p_min = -1.2,
